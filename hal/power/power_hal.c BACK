...
#define TOUCHSCREEN_PATH "/sys/devices/virtual/sec/tsp"
...
static void init_touchscreen_power_path(struct exynos5422_power_module *exynos5422_pwr)
{
    ...
    while ((de = readdir(d)) != NULL) {
        if (strncmp("input", de->d_name, 5) == 0) {
            ...
            exynos5422_pwr->touchscreen_power_path = path;
            goto done;
        }
    }
 ...
 * and other controls.
 */
static void exynos5422_power_hint(struct power_module *module, power_hint_t hint,
                             void *data)
{
    struct exynos5422_power_module *exynos5422_pwr = (struct exynos5422_power_module *) module;
    char errno_str[64];
    ...
    switch (hint) {
        case POWER_HINT_INTERACTION:
            if (boostpulse_open(exynos5422_pwr) >= 0) {
